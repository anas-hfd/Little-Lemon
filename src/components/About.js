  ...
  return (
    <section className="about_section _max_width_center">
      <section className="about_text_content" >
        ...
        Adrian and Mario, the founders of Little Lemon Restaurant welcome you to taste their Mediterranean  foods.
        Located in Chicago, Little Lemon is renowned for its delectable dishes made from fresh, local ingredients. Offering a cozy ambiance and
